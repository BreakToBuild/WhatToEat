...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        sardinhas_na_cataplana = Recepi.objects.create(
        ...
        pizza_com_peras = Recepi.objects.create(
        ...
        pica_pau_portuguesa = Recepi.objects.create(
        ...
        RecepiCategories.objects.create(
            recepi=sardinhas_na_cataplana, category=portuguesa
        )
        RecepiCategories.objects.create(recepi=pizza_com_peras, category=portuguesa)
        RecepiCategories.objects.create(recepi=pica_pau_portuguesa, category=portuguesa)
